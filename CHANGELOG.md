...
- **run_gui.py** - Python启动脚本（依赖检查）
- **启动GUI.bat** - Windows一键启动（双击即可）
- **run_gui.sh** - Unix/Linux启动脚本
...
- **GUI_USAGE_GUIDE.py** - 详细使用指南 (10000+字)
- **快速开始.txt** - 快速参考卡片
...
**detect_bird_and_eye.py - crop_species()函数**
